...
$(document).ready(function() {
    ...
    var y2k  = new Date(2014, 3, 12) //Month is 0-11 in JavaScript!
    var today= new Date();
    
    var months = Date.DateDiff('m', today, y2k)
    var monthsDisplay = (months === 1) ? "Month" : "Months";	
    document.getElementById('countdown_monthslabel').innerHTML = monthsDisplay;
    document.getElementById('countdown_monthsdata').innerHTML = months;    
