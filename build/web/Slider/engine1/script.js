...
// http://javascript-source.com
//***********************************************
jQuery("#wowslider-container1").wowSlider({effect:"stack",prev:"prev",next:"next",duration:19*100,delay:43*100,width:940,height:600,autoPlay:true,playPause:true,stopOnHover:true,loop:false,bullets:1,caption:true,captionEffect:"slide",controls:true,onBeforeStep:0,images:0});